...
window.SUSU_CATALOG = {
  ...
  "version": "1.0.0",
  "private": true,
  "description": "Curated vibecoding tool catalog for susu-tools. Canonical data source for the web directory.",
  "categories": ["ai", "dev", "design", "efficiency", "resource", "media"],
  "tools": [
    {
      "id": "chatgpt",
      "name": "ChatGPT",
